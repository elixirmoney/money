defmodule Money.Currency do
  ...
  @currencies %{
    ...
    EEK: %{name: "Kroon",                                                  symbol: "EEK",    exponent: 2},
    EGP: %{name: "Egyptian Pound",                                         symbol: "£",    exponent: 2},
    ERN: %{name: "Nakfa",                                                  symbol: "Nfk",    exponent: 2},
    ETB: %{name: "Ethiopian Birr",                                         symbol: "ETB",    exponent: 2},
    ...
    KMF: %{name: "Comoro Franc",                                           symbol: "KMF",    exponent: 0},
    ...
    MVR: %{name: "Rufiyaa",                                                symbol: "ރ",    exponent: 2},
    ...
    PGK: %{name: "Kina",                                                   symbol: "PGK",    exponent: 2},
    ...
    SZL: %{name: "Lilangeni",                                              symbol: "L",    exponent: 2},
