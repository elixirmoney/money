defmodule MoneyTest do
  ...
  test "to_string configuration defaults" do
    try do
      ...
      assert Money.to_string(zar(1234567890), separator: "|", delimeter: "§", symbol: true, symbol_space: true, fractional_unit: false) == "R 12|345|678"
      assert Money.to_string(zar(1234567890), separator: "|", delimeter: "§", symbol: true, symbol_space: true, strip_insignificant_zeros: true) == "R 12|345|678§9"
    after
